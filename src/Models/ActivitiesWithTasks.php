    ...
    public static function UpdateRedbyAdmin($id_Task)
{
    ...
    public static function AddTask()
    {
        ...
        //echo addslashes($new_FIO);
       // echo addslashes($new_email);
       // $q->bind_param('s', $new_FIO);
       // return $db->query("INSERT INTO `test` VALUES (?);", [$new_FIO], self::class);

      //  return $db->query("INSERT INTO `zadacha` VALUES (NULL,'$new_FIO','$new_email','$new_text',NULL);", [], self::class);
    }
}
